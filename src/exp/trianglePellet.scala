...
class trianglePellet(pos: Vector2, vie: Int = 1, value: Int = 20, bdyDamage: Int = 1)
  extends PhysicsPolygon("trianglePellet", pos, Array(new Vector2(0, 0), new Vector2(0, 50), new Vector2(43.3f, 25)),10,0.1f,1,true)
  with Pellet{
